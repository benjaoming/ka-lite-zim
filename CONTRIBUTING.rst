...
ka-lite-zim could always use more documentation, whether as part of the 
official ka-lite-zim docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `ka-lite-zim` for
local development.

1. Fork_ the `ka-lite-zim` repo on GitHub.
...
.. _Fork: https://github.com/Nekroze/ka-lite-zim/fork
